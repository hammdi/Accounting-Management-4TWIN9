  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      await axios.post(`${process.env.REACT_APP_API_URL}/api/invoices/sendemail`, {
        ...
        subject: `Invoice #TU${invoice.invoiceNumber || "3492"}`,
        message: `Dear ${invoice.clientName},\n\nPlease find attached your invoice #TU${invoice.invoiceNumber || "3492"}.\n\nThank you for your business.\n\nRegards,\nYour Company`,
    ...
    <div className="card">
      <div className="card-header">
        <div className="d-flex flex-wrap align-items-center justify-content-between">
          {emailSent && (
            <div className="alert alert-success mb-0">Email sent successfully to {invoiceData.clientEmail}!</div>
          )}
          {smsSent && <div className="alert alert-success mb-0">SMS sent successfully to {phoneNumber}!</div>}
          {smsError && <div className="alert alert-danger mb-0">{smsError}</div>}
                  ...
                  <div className="d-flex flex-wrap justify-content-between gap-3">
                    <div>
                      <p className="text-sm mb-0">
                        <span className="text-primary-light fw-semibold">Sales By:</span>{" "}
                      ...
                      <table className="text-sm">
                        <tbody>
                          <tr>
                            ...
                            <td className="pe-16">
                              <span className="text-primary-light fw-semibold">${invoiceData.subtotal.toFixed(2)}</span>
                            </td>
                          </tr>
                          <tr>
                            <td className="pe-64">Discount:</td>
                            <td className="pe-16">
                              <span className="text-primary-light fw-semibold">${invoiceData.discount.toFixed(2)}</span>
                            </td>
                          </tr>
                          <tr>
