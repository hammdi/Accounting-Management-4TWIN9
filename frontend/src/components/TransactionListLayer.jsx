                        ...
                        <>
                          <td>
                            {transaction.company && typeof transaction.company === 'object' && transaction.company.name ? (
                              <span>{transaction.company.name} <span className="text-muted" style={{fontSize:'0.8em'}}>({transaction.company._id || transaction.company})</span></span>
                            ) : (
                          ...
                          <div className="card border-0">
                            <div className="card-body">
                              <div className="row">
                                ...
                                <p><strong>Transaction name:</strong> {transaction.company.name}</p>
                                  <p><strong>Transaction ID:</strong> {transaction._id}</p>
                                  <p><strong>Type:</strong> {transaction.type}</p>
                                  <p><strong>Category:</strong> {transaction.category}</p>
                                  <p><strong>Amount:</strong> {transaction.amount} DT</p>
                                  <p><strong>Date:</strong> {new Date(transaction.date).toLocaleString()}</p>
                                  <p><strong>Merchant Category:</strong> {transaction.merchantCategory}</p>
                                  <p><strong>Merchant Country:</strong> {transaction.merchantCountry}</p>
