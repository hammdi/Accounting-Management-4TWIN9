    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                `${process.env.REACT_APP_API_URL}/api/payrolls/addpayroll`,
                formData,
                {
                    headers: {
            ...
            console.error('Payroll creation error:', err.response?.data);
        } finally {
            setLoading(false);
        }
    };
                    ...
                    <div className="col-xxl-6 col-xl-8 col-lg-10">
                        <div className="card border">
                            <div className="card-body">
                                <h6 className="text-md text-primary-light mb-16">Payroll Information</h6>
                                {error && (
...
export default AddPayrollLayer;