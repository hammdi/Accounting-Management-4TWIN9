  ...
  return (
    ...
    >
      ...
      <div className="mt-12 d-flex align-items-center justify-content-between gap-10">
        ...
        <div className="d-flex align-items-center justify-content-between gap-10">
          <button type="button" className="card-edit-button text-success-600" onClick={onEdit}>
            <Icon icon="lucide:edit" className="icon text-lg line-height-1" />
          </button>
          <button type="button" className="card-delete-button text-danger-600" onClick={onDelete}>
